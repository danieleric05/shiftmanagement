                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-neutral-100">
                        <thead class="bg-neutral-50">
                            <tr>
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-neutral-600">Date</th>
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-neutral-600">Action</th>
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-neutral-600">Sur quoi</th>
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-neutral-600">Par qui</th>
                        ...
                        <tbody class="divide-y divide-neutral-100 bg-white">
                            <template v-for="activite in activites.data" :key="activite.id">
                                <tr>
                                    <td class="whitespace-nowrap px-6 py-4 text-sm text-neutral-600">{{ activite.date }}</td>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-sm text-neutral-600">{{ activite.causeur }}</td>
                                ...
                                <tr v-if="detailsOuverts === activite.id">
                                    <td colspan="5" class="bg-neutral-50 px-6 py-4">
                                        <pre class="overflow-x-auto whitespace-pre-wrap break-all text-xs text-neutral-700">{{ JSON.stringify(activite.proprietes, null, 2) }}</pre>
                                    </td>
                                </tr>
                            </template>
                        </tbody>
