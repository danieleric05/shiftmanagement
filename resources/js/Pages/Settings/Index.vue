...
const sections = [
    { nom: 'Pieux', description: 'Gérer la liste des pieux utilisés dans les fiches Serviteur.', route: 'settings.pieux.index' },
    ...
    { nom: "Étapes du parcours", description: "Gérer les étapes du parcours d'intégration des serviteurs.", route: 'settings.workflow-steps.index' },
