            ...
            <div class="rounded-xl bg-white dark:bg-neutral-800 p-6 shadow-card ring-1 ring-neutral-100 dark:ring-neutral-700">
                ...
                <div v-else class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-neutral-100 dark:divide-neutral-700">
                        <thead>
                            <tr>
                                <th class="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Shift</th>
                                ...
                                <th class="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Raison</th>
                                <th class="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Date</th>
                                <th class="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Discussion</th>
                                <th class="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Résultat / Date</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-neutral-100 dark:divide-neutral-700">
                            <tr v-for="d in releves.recentes" :key="d.id">
                                <td class="px-3 py-2.5 text-sm text-neutral-600 dark:text-neutral-400">{{ d.shift }}</td>
                                <td class="px-3 py-2.5 text-sm text-neutral-900 dark:text-neutral-100">{{ d.servant }}</td>
                                <td class="px-3 py-2.5 text-sm text-neutral-600 dark:text-neutral-400">{{ d.coordonnees ?? '—' }}</td>
                                <td class="px-3 py-2.5 text-sm text-neutral-600 dark:text-neutral-400">{{ d.motif }}</td>
                                <td class="px-3 py-2.5 whitespace-nowrap text-sm text-neutral-600 dark:text-neutral-400">{{ d.date_demande }}</td>
                                <td class="px-3 py-2.5 text-sm text-neutral-600 dark:text-neutral-400">{{ d.discussion_servant ?? '—' }}</td>
                    ...
                    <table class="min-w-full divide-y divide-neutral-100 dark:divide-neutral-700">
                        <thead>
                            <tr>
                                <th class="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Shift</th>
                                <th class="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Nom</th>
                                <th class="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Shift de/à</th>
                                <th class="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Raison</th>
                                <th class="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Date</th>
                                <th class="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Approuvé 2 shifts</th>
                                <th class="px-3 py-2 text-left text-xs font-medium uppercase tracking-wide text-neutral-600 dark:text-neutral-400">Résultat / Date</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-neutral-100 dark:divide-neutral-700">
                            <tr v-for="d in permutations.recentes" :key="d.id">
                                <td class="px-3 py-2.5 text-sm text-neutral-600 dark:text-neutral-400">{{ d.shift }}</td>
                                <td class="px-3 py-2.5 text-sm text-neutral-900 dark:text-neutral-100">{{ d.servant }}</td>
                                <td class="px-3 py-2.5 text-sm text-neutral-600 dark:text-neutral-400">{{ d.shift }} → {{ d.shift_destination }}</td>
                                <td class="px-3 py-2.5 text-sm text-neutral-600 dark:text-neutral-400">{{ d.motif }}</td>
                                <td class="px-3 py-2.5 whitespace-nowrap text-sm text-neutral-600 dark:text-neutral-400">{{ d.date_demande }}</td>
                                <td class="px-3 py-2.5 text-sm">
