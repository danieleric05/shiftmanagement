...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="mx-auto max-w-4xl space-y-6">
            <div v-if="!servant" class="rounded-xl bg-white p-8 text-center text-neutral-600 shadow-card ring-1 ring-neutral-100">
                Votre compte n'est associé à aucune fiche Servant pour le moment.
                Contactez un administrateur pour lier votre compte.
            </div>

            <template v-else>
                <div class="flex items-center justify-between rounded-xl bg-white p-6 shadow-card ring-1 ring-neutral-100">
                    <div>
                ...
                <div class="rounded-xl bg-white p-6 shadow-card ring-1 ring-neutral-100">
                    ...
                    <div v-if="affectations.length === 0" class="text-sm text-neutral-600">
