...
<template>
    <LegalLayout title="Politique de confidentialité">
        ...
        <ul>
            ...
            <li>Fiche Serviteur : nom, prénom, genre, téléphone, adresse, date de naissance, photo.</li>
        ...
        <p>
            ...
            plannings, ses serviteurs et sa gouvernance interne. Elles ne sont ni vendues, ni partagées à des
        ...
        <ul>
            <li>
                ...
                corriger à tout moment les informations d'une fiche Serviteur.
            </li>
            <li>
                <strong>Accès et portabilité</strong> : l'administrateur peut exporter, au format structuré,
                l'ensemble des données personnelles détenues sur une fiche Serviteur (identité, parcours,
                historique d'affectations).
            </li>
            <li>
                <strong>Effacement</strong> : l'administrateur peut anonymiser une fiche Serviteur — nom, photo,
